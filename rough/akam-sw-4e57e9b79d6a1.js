! function() {
    ...
    const e = "content-type",
        ...
        i = "x-akam-sw-version",
        r = "x-akam-sw-debug",
        s = "x-akam-sw-extended-debug",
        n = "x-akam-sw-spof-type",
        ...
        forceValid() {
            ...
            for (const i of t) {
                let t = R[i],
                    r = this[i],
                    s = e[i];
                if (s.message && s.message.includes("bad regex")) {
                    j(`Removing bad regex from ${i} at indices ${JSON.stringify(s.indices)}`);
                    for (let e = s.indices.length - 1; e >= 0; e--) {
                        let t = s.indices[e];
                        r.splice(t, 1)
                    }
        ...
        validatePolicyParams() {
            ...
            return this.AdaptiveSPOFTimeoutEnable && (t = this.AdaptiveSPOFTimeoutEnable), Object.keys($).forEach(i => {
                let r = this[i],
                    s = typeof r,
                    n = typeof R[i];
                if ("undefined" === s)["IsBakedPolicy", "MinimumPolicyUpdateTime", "AdaptiveSPOFTimeoutEnable", "AdaptiveSPOFRTTMultiplier", "SPOFExclusionRegEx"].includes(i) || (t || !t && !["MinimumSPOFTimeout", "MaximumSPOFTimeout"].includes(i)) && (e[i] = "missing param");
                else if (s !== n) e[i] = `wrong type: is ${s}, should be ${n}`;
                else if ("number" === s) i.includes("SPOF") && r < 1 ? e[i] = `bad value: is ${r}, should be >= 1` : "MaximumSPOFTimeout" === i && r < this.MinimumSPOFTimeout && (e[i] = `bad value: is ${r}, should be greater than MinimumSPOFTimeout (${this.MinimumSPOFTimeout})`);
                else if ("object" !== s || Array.isArray(r)) {
                    if (i.includes("RegEx"))
                ...
                } else e[i] = `wrong type: is ${s}, should be array object`
            }), e
        }
    ...
    async function I(e, t) {
        ...
        let s = C.persistentState.policyRequestSerial,
            n = e => {
                (function(e) {
                    let t = new Map;
        ...
        let a = async function() {
            ...
            if (C.persistentState.policyRequestSerial > s) j(`Stale policy update; from policyRequestSerial ${s} but current serial is ${C.persistentState.policyRequestSerial}`);
            else {
    ...
    class W {
        ...
        fetchOutward(e, t) {
            return (async () => {
                ...
                try {
                    ...
                    T.otherSwFetchDisabled && T.otherSwFetchDisabled.has(e.request.url) && T.otherSwFetchDisabled.delete(e.request.url)
                }
            })()
        }
        calculateAdaptiveSPOFTimeout(e) {
            let t = this.policy().MinimumSPOFTimeout,
                ...
                r = t,
                s = t;
            "connection" in e && "chrome" === C.spofType ? s = e.connection.rtt : (void 0 === (s = C.navigationTimingAPIResponse) && (s = t), C.extendedDebug && (C.navigationTimingUsed = !0));
            let n = P;
            this.policy().AdaptiveSPOFRTTMultiplier && (n = this.policy().AdaptiveSPOFRTTMultiplier);
            let o = Math.ceil(s / 1e3) * n;
        ...
        originalPageFetchHandler(e) {
            ...
            e.respondWith3pmInternal(i), i.then(t => {
                ...
                this.log(`Service Worker Status: ${JSON.stringify(s,null,"\t")}`), e.waitPromise.resolve()
            }).catch(t => {
            ...
            if (this.dequeueAndPostMessage(), this.disabled) t.waitPromise.resolve();
                ...
                if (d = function(e) {
                        let t = e.url,
                            i = new URL(t),
                            r = !1,
                            s = i.pathname.endsWith(".js");
                        void 0 !== e.destination ? "script" === e.destination ? r = !0 : "" === e.destination && (r = s) : r = s;
                        return r
                    }(r), void 0 !== r.destination ? "script" === r.destination && (u = !0) : u = d && c && "*/*" === c && "no-cors" === r.mode, i.findByPattern(i.BlockUrlMatchRegEx, s) && d) {
                    this.log(`Blocking (Override List): ${s}`);
                    let i = {};
                    i[e] = "application/javascript", i[l] = "true", t.respondWith3pmInternal(new Response("", {
                        status: 403,
                        headers: i
                    })), t.waitPromise.resolve(), a = !0, this.postToBoomerangActionTaken(this, s, v.blocked)
                }
                if (!a && i.findByPattern(i.DeferUrlMatchRegEx, s) && d) {
                    this.log(`Deferring (Override List): ${s}`);
                    let i = D(r),
                        n = {};
                    n[e] = "application/javascript", n[o] = "true", t.respondWith3pmInternal(new Response(i, {
                        status: 200,
                        headers: n
                    })), this.postToBoomerangActionTaken(this, s, v.deferred), t.waitPromise.resolve(), a = !0
                }
                if (!a && i.findExact(i.BlockUrlMatchExact, s)) {
                    this.log(`Blocking: ${s}`);
                    let i = {};
                    i[e] = "application/javascript", i[l] = "true", t.respondWith3pmInternal(new Response("", {
                        status: 403,
                ...
                if (!a && i.findExact(i.DeferUrlMatchExact, s)) {
                    this.log(`Deferring: ${s}`);
                    let i = D(r),
                        n = {};
                    n[e] = "application/javascript", n[o] = "true", t.respondWith3pmInternal(new Response(i, {
                        status: 200,
                ...
                if (!a) {
                    let e = d && u && this.policy().SPOFProtectionEnabled && n.host !== self.location.host,
                        r = function(e) {
                            let t = !1;
                            return F.forEach(i => {
                                i.test(e) && (t = !0)
                            }), t
                        }(s) || i.findByPattern(i.SPOFExclusionRegEx, s);
                    r && C.extendedDebug && (extendedState.excludedFromSpofProtect || (extendedState.excludedFromSpofProtect = []), extendedState.excludedFromSpofProtect.push(s)), (e &= !r) ? this.spofProtect(t) : t.waitPromise.resolve()
                }
            }
        }
        spofProtect(t) {
            ...
            let s = !1,
                n = void 0,
                o = void 0;
            x && (n = new AbortController, o = n.signal);
            ...
            l.catch(e => {
                k("spofProtect", `Error in SPOF protection race: ${S(e)}`, e), s = !0, t.waitPromise.resolve()
        ...
        postToBoomerangActionTaken(e, t, i, r) {
            ...
            let s = 0;
            "undefined" != typeof performance && performance && (performance.timeOrigin ? s = performance.timeOrigin : performance.timing && performance.timing.navigationStart && (s = performance.timing.navigationStart));
            let n = {
    ...
    function Q(e) {
        return "GET" === e.method && !G(e.url) && function(e) {
            let t = e.url,
                i = new URL(t),
                r = !1,
                s = i.searchParams.get(d);
            if (null == s && i.hash && i.hash.includes(d)) {
                let e = i.hash.split(d);
                for (let t = 0; t < e.length; t++) e[1] && e[1].startsWith("=true") && (r = !0)
            }
            return "true" === s && (r = !0), C.basePageFetchHandler = r, r
        }(e)
    }
        ...
        try {
            ...
            if (C.requestsActedOn || (C.requestsActedOn = 0), C.requestsActedOn++, a.pathname === y) ! function(t) {
                ...
                if (e) {
                    ...
                    H(t, n.referrer ? n.referrer : o, {
                        createNew: !0,
                        disabled: s
                    }).resourceFetchHandler(i)
                }
                i.cancelBubble || (!i.aka3pmChainedFetch && E && E(i), i.waitPromise.resolve())
            }
        } catch (e) {
    ...
    if ("undefined" != typeof self) {
        ...
        WorkerGlobalScope.prototype.fetch3pmInternal = function(e, i) {
            ...
            if (e instanceof Request) {
                let o = e;
                return n = s(n = e.url), r && (o = new Request(n, e)), t.call(this, o, i)
            }
            return n = s(e), t.call(this, n, i)
        ...
        if (i) {
            ...
            if (new URL(t, self.location.href).host === self.location.host) {
                ...
                ServiceWorkerGlobalScope.prototype.addEventListener = function(e, t, r, s) {
                    "fetch" === e ? E = t : i(e, t, r, s)
                ...
                }, self.importScripts(t), onfetch && !E && (E = onfetch, onfetch = void 0)
            }
        }
    }
}();